...
A generalized linear model is used to see if there is a correlation between for example; the amount of money people make montly and what their opinion is on their living arrangements, mainly the neighborhood in wich they live. 
